    ...
    return (
        <div className="bio" id="bio">
            ...
            <div className="bio__txt">
                ...
                <p>Au coté d'OpenclassRoom, j'ai suivi une formation d'Intégrateur Web aboutissant sur un titre RNCP de niveau 5 (équivalent BAC +2), qui m'a permis aquérir les bases du développement front-end ainsi qu'un ensemble de compétences que vous pourrez retrouver dans la section Skills</p>
